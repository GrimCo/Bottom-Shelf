...
public class Recipes
{
	...
	public static void registerRecipes(RegistryEvent.Register<IRecipe> event)
	{
		...
		event.getRegistry().register(new ShapelessOreRecipe(drinks, Content.cocktailMartiniDirty, Content.cocktailMartini, Items.GUNPOWDER).setRegistryName("martini_dirty"));
		event.getRegistry().register(new ShapelessOreRecipe(drinks, Content.cocktailPGB, Content.bottleJanxSpirit, Items.GOLDEN_APPLE, Items.REDSTONE, Items.BRICK).setRegistryName("pangalacticgargleblaster"));
